...
public class BasketController : ApiController
{
    ...
    ILogger<BasketController> logger, ICorrelationIdGenerator correlationIdGenerator)
    {
        _mediator = mediator;
    ...
    public async Task<IActionResult> Checkout([FromBody] BasketCheckout basketCheckout)
    {
        ...
        eventMesg.CorrelationId = new Guid(_correlationIdGenerator.Get());
        await _publishEndpoint.Publish(eventMesg);
        //remove the basket
        var deleteQuery = new DeleteBasketByUserNameQuery(basket.UserName);
